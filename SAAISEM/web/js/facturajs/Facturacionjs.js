...
$(document).ready(function () {
    ...
    $('#BtnConfirmar').click(function () {
        ...
        if (Obs != "") {
            swal({
                title: "¿Seguro de confirmar la Factura manual?",
                    ...
                    function () {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.msj) {
                                    swal({
                                        title: "Facturación Manual realizada correctamente!",
                                        text: "",
                                        type: "success"
                                    }, function () {
                                        //location.reload();
                                    ...
                                    //  swal("Datos no Registrados", "Lote ya existente", "error");
                                    swal({
                                        title: "Facturación no Registrada",
                                        text: "Revisar datos",
                                        type: "error"
                                    });
                                }
...
//       // return false;
//    } if(parseInt(cantidadAlm) < parseInt(cantidadSol)){
//        swal("Verificar", "La cantidad Solicitada es mayor a la existencia", "Advertencia");
//    }
//obtenerIdreg();
}
...
//                            text: "ya mamo",
                       ...
                       //   swal("Verificar", "si entre 2", "success");
                        swal({
                            title: "Verificar",
                        ...
                        swal("Verificar", "si entre", "success");
                        $('#BtnAgregar_' + elem.IdReg).prop('disabled', true);
                        $.ajax({
                            url: "FacturacionTran",
                            data: {accion: "RegistrarDatos", IdLote: elem.IdReg, CantMov: Cantidad},
