        ...
        <div class="container">
            ...
            <div>
                ...
                <div class="row">
                    ...
                    <a href="reimpDevolucionFactura.jsp?fol_gnkl=<%=fol_gnkl%>" target="_blank" class="btn btn-info">Impr Devolución</a>
                    <a class="btn btn-primary" onclick="window.open('reportes/MarbeteDevo.jsp?fol_gnkl=<%=fol_gnkl%>', '', 'width=1200,height=800,left=50,top=50,toolbar=no')">Marbete Devolución</a></li>
                </div>
                <div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class="hidden" name="fol_gnkl" value="<%=fol_gnkl%>">
                                        <button class="btn btn-block btn-info" name="accion" value="Eliminar"><span class="glyphicon glyphicon-trash"></span></button>                                        
                                        </form>
                                    </td>
