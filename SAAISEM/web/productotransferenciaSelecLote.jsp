        ...
        <div class="container">
            ...
            <table class="table table-condensed table-striped table-bordered table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        <form action="FacturacionManual" method="post">
                            <input class="hidden" name="FolLot" value="<%=rset.getString(7)%>" class="hidden" readonly=""/>
                            <input name="IdLot" value="<%=rset.getString(6)%>" class="hidden" readonly=""/>
                             <input name="IdLotval"lue=" value="<%=IdLotval%>" class="hidden" readonly=""/>
                            ...
                            <button name="accion" type="button" value="AgregarClaveFOLIO" id="BtnAgregar_<%=rset.getString(6)%>" class="btn btn-block btn-primary" onclick="return validaCantidad(this.id);"><span class="glyphicon glyphicon-ok"></span></button>
                            <!--button name="accion" value="AgregarClave" id="BtnAgregar_< %=rset.getString(6)%>" class="btn btn-block btn-primary" onclick="return validaCantidad(this.id);"><span class="glyphicon glyphicon-ok"></span></button-->
                        </form>
                    </td>
                </tr>
                <%
