        ...
        <div class="container">
            ...
            <form action="EditaPassword" method="post">
                <div class="row">
                    ...
                    <div class="col-sm-4">                        
                        ...
                        <div class="col-sm-2">
                            ...
                            <button class="form-control btn btn-info glyphicon glyphicon-random" name="action" value="ModificaSts">&nbsp;Modificar Sts</button>
                        </div>
                </div>
                <div class="row">
                    <label class="col-sm-2">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="ApellidoM" id="ApellidoM" placeholder="Ingrese Apellido Materno" value="${usuario.amaterno}" />
                    </div>
                </div>
                <div class="row">
                    <label class="col-sm-2">
