                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <select name="SelectProyect" id="SelectProyect" class="col-sm-5">
                                        ...
                                        <%                                            try {
                                                con.conectar();
                                                ResultSet Proyect = con.consulta("SELECT P.F_Id,P.F_DesProy FROM tb_uniatn U INNER JOIN tb_proyectos P ON U.F_Proyecto=P.F_Id WHERE P.F_Id not in (5) GROUP BY P.F_Id;");
                                                while (Proyect.next()) {
                                        %>
                                ...
                                <div class="row">
                                    ...
                                    <select name="SelectClave" id="SelectClave" class="col-sm-5">
                                        ...
                                        <%
                                            try {
                                                con.conectar();
                                                ResultSet Clave = con.consulta("SELECT M.F_ClaPro, CONCAT( F_ClaPro, ' [', F_DesPro, ']' ) AS F_DesPro FROM tb_medica AS M WHERE M.F_ProMichoacan = 1;");
                                                while (Clave.next()) {
                                        %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-sm-offset-2">
                                        ...
                                        <button class="btn btn-block btn-primary" id="accion" name="accion" value="Generar" >Generar <i class="glyphicon glyphicon-search"></i></button>
                                    </div>
                                    <div class="col-sm-4">
                                        <a class="btn btn-block btn-info" href="ReporteadorComprasM.jsp">Limpiar&nbsp;<i class="glyphicon glyphicon-trash"></i></a>                        
                                    </div>    
                                </div>
                            </div>
                        </div>
