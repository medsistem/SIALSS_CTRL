                ...
                <div class="panel-footer">
                    <form action="Facturacion" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4">
                                                <a class="btn btn-block btn-primary" onclick="return confirm('Desea Validar Esta Clave?')" href="Facturacion?accion=validaAuditor&folio=<%=rset.getString("F_Id")%>&Nombre=<%=Clave%>"><span class="glyphicon glyphicon-ok"></span></a>
                                            </div>
                        ...
                        <div class="row"><div class="col-sm-2 col-sm-offset-10">
                                <button class="btn btn-primary" name="accion" value="validarVariasAuditor">Validar Varias</button>
                            </div>
                        </div>
                        <%
                            }
