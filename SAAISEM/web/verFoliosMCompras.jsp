...
<html>
    ...
    <body onload="focusLocus();">
        <div class="container">
            ...
            <br/>
            <div class="row">
                <form method="post" action="verFoliosMCompras.jsp">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="Usuario" id="Usuario" onchange="">
                                ...
                                <%
                                 ...
                                 ResultSet rset = con.consulta("SELECT uc.F_IdUsu as Id_Usu, uc.F_Usu as Usu FROM tb_pedido_sialss AS p LEFT JOIN tb_usuariocompra AS uc ON p.F_IdUsu = uc.F_IdUsu  GROUP BY p.F_IdUsu HAVING Id_Usu != 'NULL' ORDER BY uc.F_Usu ASC;");
                                       while (rset.next()) {
                                %>
                                <option value="<%=rset.getString(1)%>" ><%=rset.getString(2)%></option>
                                <%
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    System.out.println("1");
                                        rset = con.consulta("SELECT o.F_NoCompra, uc.F_Usu as Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha, pr.F_DesProy FROM tb_pedido_sialss o, tb_proveedor p, tb_usuariocompra uc, tb_Proyectos pr WHERE o.F_Proyecto = pr.F_Id and uc.F_IdUsu = o.F_IdUsu  AND o.F_Provee = p.F_ClaProve and o.F_Provee = '" + request.getParameter("Proveedor") + "' and o.F_Proyecto NOT IN (5) group by o.F_NoCompra;");

                                    } else if (!(fecha.equals(""))) {
                                        rset = con.consulta("SELECT o.F_NoCompra,uc.F_Usu as Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha, pr.F_DesProy FROM tb_pedido_sialss o, tb_proveedor p, tb_usuariocompra uc, tb_Proyectos pr WHERE o.F_Proyecto = pr.F_Id and uc.F_IdUsu = o.F_IdUsu  AND o.F_Provee = p.F_ClaProve and o.F_FecSur =  '" + fecha + "%' and o.F_Proyecto NOT IN (5) group by o.F_NoCompra;");
                                     ...
                                     rset = con.consulta("SELECT o.F_NoCompra, uc.F_Usu as Usu, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y') F_FecSur, F_HorSur, F_Fecha, pr.F_DesProy FROM tb_pedido_sialss o  LEFT JOIN tb_proveedor p ON o.F_Provee = p.F_ClaProve LEFT JOIN tb_usuariocompra AS uc ON o.F_IdUsu = uc.F_IdUsu  INNER JOIN tb_Proyectos pr ON o.F_Proyecto = pr.F_Id   WHERE o.F_IdUsu =  '" + Usuario + "' and o.F_Proyecto NOT IN (5) group by o.F_NoCompra");
                                    }
         ...
         <div class="row" style="width: 90%; margin: auto;">             
             <div class="col-sm-12 table-responsive">
                 <div class="panel panel-primary">
                     <%                try {
                             con.conectar();
                             ResultSet rset = con.consulta("SELECT o.F_NoCompra, p.F_NomPro, DATE_FORMAT(o.F_FecSur, '%d/%m/%Y'), F_HorSur, uc.F_Usu as F_Usu, F_StsPed, rec.F_Recibido,o.Fecha_Vencimiento,o.Plazo_Pago FROM tb_pedido_sialss o INNER JOIN tb_proveedor p ON o.F_Provee = p.F_ClaProve LEFT JOIN tb_usuariocompra uc ON uc.F_IdUsu = o.F_IdUsu  INNER JOIN ( SELECT F_NoCompra, SUM(F_Recibido) AS F_Recibido FROM tb_pedido_sialss o WHERE F_NoCompra = '" + NoCompra + "' ) rec ON o.F_NoCompra = rec.F_NoCompra WHERE o.F_NoCompra = '" + NoCompra + "' GROUP BY o.F_NoCompra;");
                             while (rset.next()) {
                     %>
