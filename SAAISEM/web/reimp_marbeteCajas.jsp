...
<% /*Parametros para realizar la conexión*/
    ...
    String Clave = "", Cb = "", Lote = "", Cadu = "", Descrip = "", Orden = "", F_OrdCom = "", FechaA = "", Imagen = "", Origen = "";
    int idorigen = 0;
    String imgOrigen = "";
