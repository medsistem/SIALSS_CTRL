...
<html>
    ...
    <head>
        ...
        <!---->
        <title>SIS Sistema De Salidas</title>
    </head>
    <body>
        <div class="container">
            <h1>SIALSS_CTRL</h1>
            ...
            <br>
            <form id="formParametros" action="../entregas/v3" method="post">
                <div class="row">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    ...
                                    <select name="SelectClave" id="SelectClave" class="col-sm-5">
                                        ...
                                        <%
                                            try {
                                                con.conectar();
                                                ResultSet Clave = con.consulta("SELECT F_ClaPro,CONCAT(F_ClaPro,' [',F_DesPro,']') AS F_DesPro FROM tb_medica where F_ClaPro not in ('40096.')");
                                                while (Clave.next()) {
                                        %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2 col-sm-offset-2">
                                        ...
                                        <button class="btn btn-block btn-info" id="accion" name="accion" value="Generar" >Consultar<i class="glyphicon glyphicon-search"></i></button>
                                    </div>


                                    <div class="col-sm-2">
                                        <a class="btn btn-block btn-info" href="ReporteadorComprasAuditoria.jsp">Limpiar&nbsp;<i class="glyphicon glyphicon-trash"></i></a>                        
                                    </div>
            ...
            <script src="../js/reporteador/ReporteadorAud.js" type="text/javascript"></script>
