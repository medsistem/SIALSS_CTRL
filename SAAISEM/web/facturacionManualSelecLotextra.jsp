...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h2>Facturación Manual Extraordinario</h2>
                </div>
            </div>
            <hr/>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-sm-offset-6">
                                <a class="btn btn-block btn-default" href="facturacionManualExtra.jsp">Regresar</a>
                            </div>
                        </div>
            ...
            <table class="table table-condensed table-striped table-bordered table-responsive">
                ...
                <%
                    try {
                        ...
                        rset = con.consulta("SELECT l.F_ClaPro, l.F_ClaLot, DATE_FORMAT(l.F_FecCad, '%d/%m/%Y'), l.F_Ubica, l.F_ExiLot, l.F_IdLote, l.F_FolLot, m.F_DesMar, l.F_Origen, p.F_DesProy FROM tb_lote l INNER JOIN tb_marca m ON l.F_ClaMar = m.F_ClaMar INNER JOIN tb_medica me ON me.F_ClaPro = l.F_ClaPro INNER JOIN tb_proyectos p ON l.F_Proyecto = p.F_Id WHERE l.F_ClaPro = '" + ClaPro + "' AND F_ExiLot != 0 AND l.F_Proyecto = '" + Proyecto + "' AND l.F_Ubica IN ('EXTRA_ORDINARIA', 'VIRTUAL-MCH-EXTRAORD' ) ORDER BY l.F_Origen, F_FecCad ASC;");
