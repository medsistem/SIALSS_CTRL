            ...
            <form action="ConsultasMovi.jsp" method="post">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control" name="Proyecto" id="Proyecto">
                                ...
                                <%
                                    try {
                                        con.conectar();
                                        ResultSet rset = con.consulta("SELECT * FROM tb_proyectos ORDER BY F_DesProy;");
                                        while (rset.next()) {
                                %>
                        ...
                        <div class="col-sm-2">
                            <select class="form-control" name="Origen" id="Origen">
                                ...
                                <%
                                    try {
                                        con.conectar();
                                        ResultSet rset = con.consulta("SELECT * FROM tb_origen ORDER BY F_DesOri;");
                                        while (rset.next()) {
                                %>
                                <option value="<%=rset.getString(1)%>"><%=rset.getString(2)%></option>
                                <%
                ...
                <div class="panel-footer">
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="ClaCli" id="ClaCli">
                                ...
                                <%
                                    try {
                                        con.conectar();
                                        ResultSet rset = con.consulta("SELECT F_IdCon,CONCAT('[',F_IdCon,']  ',F_DesCon) AS F_DesCon FROM tb_coninv where  F_IdCon  not in (8,7,26,27,20,13,22,25,61,55,71,56,64,65,12,28,24);");
                        ...
                        <div class="col-sm-2">
                            <a href="ConsultasMovi.jsp" class="btn btn-block btn-info glyphicon glyphicon-trash">Limpiar</a>
                        </div>
