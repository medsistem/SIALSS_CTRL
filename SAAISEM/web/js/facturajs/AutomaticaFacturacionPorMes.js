            ...
            swal({
                ...
                confirmButtonText: "Continuar!"
                    ...
                    function () {
                        ...
                        $.ajax({
                            url: "FacturacionTran",
                            data: {accion: "GeneraFolioApartMichPorMes", ClaUni: checkboxValues, Catalogo: Catalogo, Tipo: Tipo, FecEnt: FecEnt, Proyecto: Proyecto, OC: OC},
                            type: 'GET',
                            dataType: 'JSON',
                            async: true,
                            success: function (data) {
                                        ...
                                        success: function (data) {
                                            if (data.msj) {
                                                swal({
                                                    ...
                                                    //location.reload();
                                                    window.location = "facturaAtomaticaPorMes.jsp";
                                                });
                                                //swal("Registrados", "", "error");
                                            } else {
                                                swal("Datos no Registrados", "", "error");
