...
import LeeExcel.LeeExcelEnseres;
 ...
 * @author Anibal GNKL
 */
@WebServlet(name = "FileUploadServletEnseres", urlPatterns = {"/FileUploadServletEnseres"})
public class FileUploadServletEnseres extends HttpServlet {

    LeeExcelEnseres lee = new LeeExcelEnseres();
                    ...
                    if (item.isFormField()) {
                        ...
                        if (FileUpload.processFile(path, item)) {
                            ...
                            if (lee.obtieneArchivo(path, item.getName(), Usuario)) {
                                ...
                                out.println("<script>window.location='requerimientoEnseres.jsp'</script>");
                            }
