    ...
    <body>
        <div class="container">
            ...
            <form action="transferproducproyecto.jsp" method="post">
                <button class="btn btn-block btn-primary" name="accion" value="nuevoFolio">Nueva Tranferencia</button>
            </form>
            <%
            } else {
            %>
            <form action="FacturacionManual" method="post">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-primary btn-block" name="accion" value="btnClaveTP" id="btnClaveTP" onclick="return validaUni();">Buscar</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-block btn-primary" name="accion" value="SeleccionaLoteTP" onclick="return validaSeleccionar();">Seleccionar</button>
                            </div>
                        </div>
                ...
                <table class="table table-condensed table-striped table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-block btn-info" name="accionEliminar" value="<%=rset.getString("F_Id")%>" onclick="return confirm('Seguro que desea eliminar esta clave?')"><span class="glyphicon glyphicon-remove"></span></button>
                        </td>
                    </tr>
                    <%
                            }
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <button class="btn btn-block btn-info" name="accion" value="CancelarFactura" onclick="return confirm('Seguro de CANCELAR la Factura?')">Cancelar Factura</button>
                    </div>
                </div>
