            ...
            <div class="panel-body panel-default">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="get" action="Modificaciones">
                                ...
                                <button class="btn btn-info" onclick="return confirm('¿Seguro de que desea eliminar?');" name="accion" value="eliminar"><span class="glyphicon glyphicon-remove"></span></button>
                            </form>
                        </td>
                    </tr>
                    <%
                    ...
                    <tr>
                        ...
                        <td colspan="2"><form action="Nuevo" method="post">
                                <input name="fol_gnkl" type="text" style="" class="hidden" value="<%=folio_gnk%>" />
                                <button  value="Guardar" name="accion" class="btn btn-info btn-block" onclick="return confirm('Seguro que desea realizar la compra?');
                                        return validaCompra();">Confirmar Compra</button></form></td>
                        <!--td colspan="2"><a href="Reporte.jsp" target="_blank" class="btn btn-primary btn-block">Imprimir</a></td-->
                    </tr>
                    <%
                        }
                    %>
