        ...
        while (rset.next()) {
                        ...
                        <div class="row">
                            <div class="form-group">                                
                                ...
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m1" name="m1" maxlength="5" placeholder="M1" value="<%=rset.getString(6)%>"/><!--a href="" class="btn btn-block btn-info">?</a-->
                                </div>                                
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m2" name="m2" maxlength="5" placeholder="M2" value="<%=rset.getString(7)%>" /><!--a href="" class="btn btn-block btn-info">?</a-->
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m3" name="m3" maxlength="5" placeholder="M3" value="<%=rset.getString(8)%>" /><!--a href="" class="btn btn-block btn-info">?</a-->
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m4" name="m4" maxlength="5" placeholder="M4" value="<%=rset.getString(9)%>" /><!--a href="" class="btn btn-block btn-info">?</a-->
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m5" name="m5" maxlength="5" placeholder="M5" value="<%=rset.getString(10)%>" /><!--a href="" class="btn btn-block btn-info">?</a-->
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m6" name="m6" maxlength="5" placeholder="M6" value="<%=rset.getString(11)%>" /><!--a href="" class="btn btn-block btn-info">?</a-->
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m7" name="m7" maxlength="5" placeholder="M7" value="<%=rset.getString(12)%>" /><!--a href="" class="btn btn-block btn-info">?</a-->
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m8" name="m8" maxlength="5" placeholder="M8" value="<%=rset.getString(13)%>" /><!--a href="" class="btn btn-block btn-info">?</a-->
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m9" name="m9" maxlength="5" placeholder="M9" value="<%=rset.getString(14)%>" /><!--a href="Modulos.jsp?M" class="btn btn-block btn-info">?</a-->
                                </div>
                                <div class="col-xs-1">
                                    <input type="text" class="form-control" id="m10" name="m10" maxlength="5" placeholder="M10" value="<%=rset.getString(15)%>" /><!--a href="Modulos.jsp?M" class="btn btn-block btn-info">?</a-->
                                </div>
                            </div>
                        </div>        
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                              <button class="btn btn-block btn-primary" type="submit" name="accion" value="ActualizarUnidis">Modificar</button>   
                            </div>
                            <div class="col-sm-6">
                                <a href="catalogoUniDis.jsp" class="btn btn-block btn-info" type="submit" name="accion" value="Regresar">Regresar</a>   
                            </div>
                        </div>
                    </form>
                    <div>
