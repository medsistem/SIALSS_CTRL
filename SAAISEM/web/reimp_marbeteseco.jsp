...
<% /*Parametros para realizar la conexión*/
    ...
    String Clave = "", Cb = "", Lote = "", Cadu = "", Descrip = "", Orden = "", F_OrdCom = "", FechaA = "", DesProy = "", Contrato = "", Origen = "", Folio = "";
    ...
    File reportFile = new File(application.getRealPath("/reportes/MarbeteSeco.jasper"));
    /* No enviamos parámetros porque nuestro reporte no los necesita asi que escriba 
     cualquier cadena de texto ya que solo seguiremos el formato del método runReportToPdf*/
    Map parameters = new HashMap();
    parameters.put("folmar", folio_gnk);
  //  parameters.put("folma", request.getParameter("fol_gnkl"));
