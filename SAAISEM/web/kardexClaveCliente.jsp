                ...
                <div class="panel-body">
                    <form name="FormKardex" action="kardexClaveCliente.jsp" method="Post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <a class="btn btn-primary form-control" a href="gnrKardexClave.jsp?Clave=<%=Clave%>&Lote=<%=request.getParameter("Lote")%>&Cadu=<%=request.getParameter("Cadu")%>&Btn=<%=request.getParameter("accion")%>&ProyectoCL=<%=ProyectoCL%>">Reporte de Trazabilidad</a>
                            </div>
                        </div>
                    </form>
                    <hr/>
