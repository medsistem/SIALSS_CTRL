...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form name="forma1" id="forma1" action="AdministraRemisionesProvisionales" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${detalle.ver == 'SI'}">
                                                    <a href="ImprimeFolioProvisional?fol_gnkl=<c:out value="${detalle.folio}" />&Proyecto=<c:out value="${detalle.idproyecto}" />&BanDato=<c:out value="${detalle.ban}" />&idProyecto=<c:out value="${detalle.idproyecto}" />&controlado=<c:out value="${detalle.controlado}"/>&idFolio=<c:out value="${detalle.idFolio}"/>" target="_blank" class="btn btn-block btn-primary"><span class="glyphicon glyphicon-print"></span></a>
                                                    </c:if>
                                            </td>                                                                        
                                            
                                            <td>
                                                <c:if test="${detalle.ver == 'SI'}">
                                                    <a class="btn btn-block btn-primary" href="gnrFacturaProvisionalExcel.jsp?fol_gnkl=<c:out value="${detalle.folio}" />&idProyecto=<c:out value="${detalle.idproyecto}" />&idFolio=<c:out value="${detalle.idFolio}"/>"><span class="glyphicon glyphicon-save"></span></a>
                                                    </c:if>
                                            </td>
 <!--                                           <td>
                                                <c:if test="${detalle.ver == 'SI'}">
