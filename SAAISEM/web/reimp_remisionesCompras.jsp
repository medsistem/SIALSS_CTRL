    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <!--div class="col-sm-2">
                    <br/>
                    <a class="btn btn-primary" href="gnrFacturaConcentrado.jsp?f1=<%=Fecha1%>&f2=<%=Fecha2%>" target="_blank">Exportar Global</a>
                </div-->
            </div>
            <form name="forma1" id="forma1" action="AdministraRemisionesCompras" method="post">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <!--div class="col-sm-3">
                            <button class="btn btn-block btn-info" name="Accion" value="exportarDispen" onclick="return confirm('Seguro que desea exportar los Folios por Dispensador?');">Exportar por Dispensador&nbsp;<label class="glyphicon glyphicon-floppy-saved"></label></button>                        
                        </div-->
                    </div>
                </div>  
                <div>
                                ...
                                <tbody>
                                    <c:forEach items="${listaRemision}" var="detalle">
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${detalle.ver == 'SI'}">
                                                    <a class="btn btn-block btn-primary" href="gnrFacturaExcel.jsp?fol_gnkl=<c:out value="${detalle.folio}" />&idProyecto=<c:out value="${detalle.idproyecto}" />&BanDato=1&controlado=1"><span class="glyphicon glyphicon-save"></span></a>
                                                    </c:if>
                                            </td>
                                            <td>
                                                <c:if test="${detalle.ver == 'SI'}">
                                                    <a class="btn btn-info btn-block" target="_black" href="facturacion/generaAbastoCSVCompra.jsp?F_ClaDoc=<c:out value="${detalle.folio}"/>&ConInv=<c:out value="${detalle.claveuni}"/>&idProyecto=<c:out value="${detalle.idproyecto}" />&BanDato=1&controlado=1"><span class="glyphicon glyphicon-download"></span></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary" id="<c:out value="${detalle.folio}" /><c:out value="${detalle.idproyecto}" />" disabled onclick="return validaCancel(this.id);" name="accion" value="CancelarFolio">Cancelar</button>
