...
public class Proveedor extends HttpServlet {
                ...
                try {
                    ...
                    try {
                        ...
                        if (!(Nombre.equals(""))) {
                            ...
                            ProveedorObject p = new ProveedorObject(request);
                            con.insertar("insert into tb_proveedor values (0,'" + p.nombre.toUpperCase() + "', '" + p.direccion.toUpperCase() + "', '" + p.colonia.toUpperCase() + "', '" + p.cp.toUpperCase() + "', '" + p.telefono.toUpperCase() + "', '" + p.rfc.toUpperCase() + "', '" + p.fax.toUpperCase() + "', '" + p.mail.toUpperCase() + "','','');");
    ...
    private class ProveedorObject {
        ...
        public ProveedorObject(HttpServletRequest request) {
