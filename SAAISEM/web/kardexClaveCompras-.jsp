                    ...
                    <form name="FormKardex" action="kardexClaveCompras.jsp" method="Post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                ...
                                %>
                                <a class="btn btn-primary" a href="gnrKardexClave.jsp?Clave=<%=Clave%>&Lote=<%=request.getParameter("Lote")%>&Cadu=<%=request.getParameter("Cadu")%>&Btn=<%=request.getParameter("accion")%>">Reporte de Trazabilidad</a>
                                <%
                                    /* }
                                    } catch (Exception e) {
