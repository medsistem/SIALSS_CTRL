                            ...
                            <table class="table table-bordered table-striped" id="datosCompras">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="reimpReporte.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&fecha=<%=rset.getString(4)%>" target="_blank" class="btn btn-block btn-primary">ACUSE MDF</a>
                                        </td>
                                        <!-- <td>
                                       ...
                                       <td>
                                            <a href="reimp_marbete.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&Ban=2" target="_blank" class="btn btn-block btn-info">TARIMAS A</a>
                                        </td>
                                        
                                        <td>
                                            <a href="reimp_marbeteCajas.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&Ban=1" target="_blank" class="btn btn-block btn-primary">CAJAS</a>
                                        </td>
                                        
                                        <td>
                                            <a href="verCompra.jsp?F_FolRemi=<%=rset.getString("F_FolRemi")%>&F_OrdCom=<%=rset.getString("F_OrdCom")%>&fol_gnkl=<%=rset.getString(1)%>&F_FecApl=<%=rset.getString(4)%>" target="_blank" class="btn btn-block btn-default">VER</a>
                                        </td>
