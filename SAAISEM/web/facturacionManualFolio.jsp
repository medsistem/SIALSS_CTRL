            ...
            <form action="FacturacionManual" method="post">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <button class="btn btn-primary btn-block" name="accion" value="btnClaveFOLIO" id="btnClaveFOLIO" onclick="return validaUni();">Buscar</button>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-condensed table-striped table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-block btn-danger" name="accionEliminarFOLIO" value="<%=rset.getString("F_Id")%>" onclick="return confirm('Seguro que desea eliminar esta clave?')"><span class="glyphicon glyphicon-remove"></span></button>
                        </td>
                    </tr>
                    <%
                            }
