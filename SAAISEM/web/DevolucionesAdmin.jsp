...
<%
    ...
    if (sesion.getAttribute("nombre") != null ) {
        ...
        if(!tipo.equals("1") && !tipo.equals("7") && !tipo.equals("12") && !tipo.equals("9")  && !username.equals("ivaned") && !username.equals("robert")  ){
        ...
        <div class="container">
            ...
            <div class="panel-footer">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                            <button class="btn btn-block btn-primary" name="Accion" value="btnMostrarDev" >MOSTRAR&nbsp;<label class="glyphicon glyphicon-search"></label></button>                        
                        </div>
                </div>   
            </div>
            <div>
                        ...
                        <table class="table table-bordered table-striped" id="datosCompras">
                            <thead>
                                <tr>
                                     ...
                                     <th scope="col">Documento Devolución</th>
                                     <th scope="col">Clave Cli.</th>
                                     <th scope="col">Nombre</th>
                                     <th scope="col">Fec. Ent.</th>
                                     <th scope="col">Documento Referencia</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text-center"><c:out value="${detalle.fechamov}" /></td>
                                    <td class="text-center"><c:out value="${detalle.docmovimiento}" /></td>
                                    <td class="text-center"><c:out value="${detalle.claveuni}" /></td>
                                    <td><c:out value="${detalle.unidad}" /></td>
                                    <td class="text-center"><c:out value="${detalle.fechaentrega}" /></td>
                                    <td class="text-center"><c:out value="${detalle.docreferencia}" /></td>
                                    <td class="text-center"><c:out value="${detalle.desproy}" /></td>
                                    <td class="text-center"><a href="reimpDevolucion.jsp?fol_gnkl=<c:out value="${detalle.docmovimiento}" />" target="_blank"  class="btn btn-block btn-info form-control glyphicon glyphicon-print"></a></td>
                                    <td class="text-center"><a href="reportes/MarbeteDevo.jsp?fol_gnkl=<c:out value="${detalle.docreferencia}" />&Proyecto=<c:out value="${detalle.proyecto}" />" target="_blank"  class="btn btn-block btn-primary form-control glyphicon glyphicon-print"></a></td>
                                </tr>
                                </c:forEach>
                            </tbody>
                        </table>
