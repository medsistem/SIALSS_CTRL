                            ...
                            <table class="table table-bordered table-striped" id="datosCompras">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="reimpReporteEnseres.jsp?F_FolRemi=<%=rset.getString(2)%>&F_OrdCom=<%=rset.getString(3)%>&fol_gnkl=<%=rset.getString(2)%>&fecha=<%=rset.getString(5)%>" target="_blank" class="btn btn-block btn-primary">Imprimir</a>
                                        </td>
                                    </tr>
                                    <%
                                                    }
