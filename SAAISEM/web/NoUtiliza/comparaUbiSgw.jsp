            ...
            <div class="text-center">
                <form method="post" name="form" id="form">
                    <div class="row">
                        ...
                        <div class="col-lg-2"><button class="btn btn-block btn-primary" name="accion" value="lote">Clave y Lote</button></div>
                        ...
                        <div class="col-lg-2"><a href="excel/excelDiferencias.jsp?accion=lote&ceros=<%=ceros%>" target="_blank" class="btn btn-block btn-primary ">Exportar con Lote</a></div>
                    </div>
                </form>
                <br />
                <div>
