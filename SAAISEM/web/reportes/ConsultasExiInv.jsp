                            ...
                            <div style="width:100%; height:400px; overflow:auto;">
                                <table class="table table-bordered table-striped">
                                    <thead>
                                        <tr>
                                            <th>Mes/Año</th>
                                            <th>Inv. Inicio Mes</th>
                                            <th>Entrada Por Inv. Inicial</th>                                            
                                            <th>Entrada Por Compra</th>
                                            <th>Entrad Por Devoluci&oacute;n</th>
                                            <th>Entrada Por Otros Movimientos</th>
                                            <th>Salida Por Facturaci&oacute;n</th>
                                            <th>Salida Por Otros Movimientos</th>
                                            <th>Inv. Final Mes</th>
                                            <th>Descargar</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <%                                            try {
                                                ...
                                                int anno = 0, mes = 0, mesd = 0, dia = 0, FechaE =0, annoIni = 2018;
                                                ...
                                                ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov='11' AND F_FecMov BETWEEN '"+annoIni+"-02-15' AND '"+ annoIni+"-12-31';");
                                                //ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov='11' AND F_FecMov BETWEEN '2018-02-15' AND '"+ FechaE+"-12-31';");
                                                ...
                                                if(annoIni == 2018){
                                                    System.out.println("suma 2018:"+InvIni);
                                                     con.insertar("INSERT INTO tb_invmescedisglobal VALUES('AÑO "+annoIni+" - "+annoIni+"','0','" + InvIni + "','0','0','0','0','0','0','12','"+annoIni+"',0)");
                                                }else{
                                                    System.out.println("suma mas años:"+InvIni);
                                                     con.insertar("INSERT INTO tb_invmescedisglobal VALUES('AÑO "+annoIni+" - "+annoIni+"',"+InvFinal+",'" + InvIni + "','0','0','0','0','0','0','12','"+annoIni+"',0)");
                                                }
                                                

                                                ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov='1' AND F_FecMov BETWEEN '2018-02-15' AND '"+annoIni+"-12-31';");
                                                if (ConsultaMov.next()) {
                                                ...
                                                ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov in (3,4,5,6,20,26,27) AND F_FecMov BETWEEN '"+annoIni+"-02-15' AND '"+annoIni+"-12-31';");
                                                if (ConsultaMov.next()) {
                                                ...
                                                ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov in (2,7,8,9,10,13,16,18,19,22,23,24,25,28,30)  AND F_FecMov BETWEEN '"+annoIni+"-02-15' AND '"+annoIni+"-12-31';");
                                                if (ConsultaMov.next()) {
                                                ...
                                                ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov = '51' AND F_FecMov BETWEEN '"+annoIni+"-02-15' AND '"+annoIni+"-12-31';");
                                                if (ConsultaMov.next()) {
                                                ...
                                                ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov > '51' AND F_ConMov < '1000' AND F_FecMov BETWEEN '"+annoIni+"-02-15' AND '"+annoIni+"-12-31';");
                                                if (ConsultaMov.next()) {
                                                ...
                                                for (mes = 1; mes <= mesd; mes++) {
                                                    ...
                                                    if (mes == 1) {
                                                        ...
                                                        if ((anno == 2020) || (anno == 2024) || (anno == 2028)) {
                                                            dia = 29;
                                                        } else {
                                                            dia = 28;
                                                        }
                                                   ...
                                                   // FechaF = "2019" + "-" + MesT + "-" + dia;
                                                    ...
                                                    ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov in (3,4,5,6,20,26,27) AND F_FecMov BETWEEN '" + FechaI + "' AND '" + FechaF + "';");
                                                    if (ConsultaMov.next()) {
                                                        Devo1 = ConsultaMov.getInt(1);
                                                    }
                                                    con.actualizar("UPDATE tb_invmescedisglobal SET F_Devo='" + Devo1 + "' WHERE F_Nmes='" + mes + "' AND F_Anno='" + anno + "';");

                                                    ConsultaMov = con.consulta("SELECT SUM(F_CantMov) FROM tb_movinv WHERE F_ConMov in (2,7,8,9,10,13,16,18,19,22,23,24,25,26,27,28,30) AND F_FecMov BETWEEN '" + FechaI + "' AND '" + FechaF + "';");
                                                    if (ConsultaMov.next()) {
