                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${detalle.ver == 'SI'}">
                                                    <a href="ImprimeFolio?fol_gnkl=<c:out value="${detalle.folio}" />&Proyecto=<c:out value="${detalle.idproyecto}" />&idProyecto=<c:out value="${detalle.idproyecto}" />" target="_blank" class="btn btn-block btn-primary"><span class="glyphicon glyphicon-print"></span></a>
                                                    </c:if>
                                            </td>
                                            <td>
                                                <c:if test="${detalle.ver == 'SI'}">
