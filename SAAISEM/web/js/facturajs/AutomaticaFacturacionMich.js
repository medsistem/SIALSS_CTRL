...
$(document).ready(function () {
    ...
    $('#BtngenerarRemision').click(function () {
        ...
        var checkboxValues = "";
        var Obs = "";
        var tablaUnireq = $('#tablaUnireq').val(); 
            ...
            swal({
                ...
                confirmButtonText: "Continuar!"
                    ...
                    function () {
                        ...
                        $.ajax({
                            type: "GET",
                            url: "FacturacionTran?accion=obtenerIdRegFactAuto&ClaUni=" + checkboxValues + "&Catalogo=" + Catalogo + "&tablaUnireq="+tablaUnireq,
                            dataType: "json",
                            async: false,
                            success: function (data) {
                                $.each(data, function (idx, elem) {
                                    ...
                                    $.ajax({
                                        url: "FacturacionTran",
                                        data: {accion: "ActualizaReqId", ClaUni: elem.ClaUni, ClaPro: elem.ClaPro, IdRegistro: elem.IdReg, Catalogo: Catalogo, Cantidad: Cantidad, CantidadReq: CantidadReq, Obs: Obs,tablaUnireq:tablaUnireq},
                                        type: 'GET',
                                        dataType: 'JSON',
                                        async: true,
                                        success: function (data) {
                        ...
                        $.ajax({
                            url: "FacturacionTran",
                            data: {accion: "GeneraFolioApartMich", ClaUni: checkboxValues, Catalogo: Catalogo, Tipo: Tipo, FecEnt: FecEnt, Proyecto: Proyecto, OC: OC,tablaUnireq:tablaUnireq},
                            type: 'GET',
                            dataType: 'JSON',
                            async: true,
                            success: function (data) {
