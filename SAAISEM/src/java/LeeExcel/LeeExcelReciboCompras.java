...
public class LeeExcelReciboCompras {
    ...
    public boolean obtieneArchivo(String path, String file, String Usuario, String Proyecto, String Campo) {
    ...
    public void displayDataExcelXLSX(Vector vectorData, String User, String Proyecto, String Campo) {
        ...
        try {
            con.conectar();
            con.actualizar("DELETE FROM tb_cargaoc WHERE F_NoOc='Oc' AND F_Usu='" + User + "';");
            ...
            con.actualizar("UPDATE tb_cargaoc O INNER JOIN tb_medica M ON O.F_Clave = M.F_ClaPro SET O.F_Clavess = M.F_ClaProSS WHERE O.F_Usu='" + User + "' AND " + Campo + " = 1;");

            con.actualizar("UPDATE tb_cargaoc O INNER JOIN tb_medica M ON O.F_Clave = M.F_ClaPro AND O.F_Clavess = M.F_ClaProSS SET O.F_ProblemaClave=1 WHERE O.F_Usu='" + User + "' AND " + Campo + " = 1;");
            ...
            while (Consulta.next()) {
                ...
                if ((NoReg == NoClave) && (NoReg == NoProvee) && (NoReg == NoProyecto)) {
                    ...
                    while (Claves.next()) {
                        //con.insertar("INSERT INTO tb_pedido_sialss VALUES(0,'" + Claves.getString(1) + "','" + Claves.getString(2) + "','" + Claves.getString(3) + "','" + Claves.getString(4) + "','-','-','-',CURDATE(),'" + Claves.getString(5) + "','-',NOW(),CURDATE(),CURTIME(),48,1,0,'" + Claves.getString(6) + "')");
