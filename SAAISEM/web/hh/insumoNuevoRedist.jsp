...
<html>
    ...
    <body>
        <div class="container">
            ...
            <br/>
            <!--a class="btn btn-block btn-primary btn-lg" href="ubiAntRedist.jsp">Insumo Ya Ubicado</a-->
            <a class="btn btn-block btn-primary btn-lg" href="leerInsRedistCBUbica.jsp">Insumo Ya Ubicado</a>
            <br/>
            <form action="leerInsRedistClave.jsp" method="post">
                <input name="UbiAnt" value="1" class="hidden">
                <button type="submit" class="btn btn-block btn-info btn-lg">Por Clave de Insumo</button>
            </form>
        </div>
