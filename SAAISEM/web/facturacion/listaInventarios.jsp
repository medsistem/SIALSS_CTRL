        ...
        <table class="table table-bordered table-condensed table-striped" id="tablInventarios">
            ...
            <tbody>
                <%
                    try {
                     con.conectar();
                        ResultSet rset = con.consulta("select * from v_inventarios where cla_jur in (" + juris + ") and user not in ('usuario20', 'usuario21', 'usuario22', 'usuario23', 'usuario24', 'usuario25') group by idInv");
                        while (rset.next()) {
