        ...
        <div class="container">
            ...
            <div>
                ...
                <form class="form-horizontal" action="../Usuarios" name="formulario1" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <button class="btn btn-primary btn-block" name="accion" value="Modificar" onclick="return validaUsuario();">Modificar</button>
                        </div>
                        <div class="col-sm-6">
                            <button class="btn btn-info btn-block" name="accion" value="Eliminar" onclick="return confirm('¿Seguro que desea eliminar al usuario?')">Eliminar</button>
                        </div>
                    </div>
                </form>
            </div>
