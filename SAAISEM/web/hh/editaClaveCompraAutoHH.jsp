...
<%
    ...
    String folio_gnk = "", fecha = "", folio_remi = "", orden = "", provee = "", recib = "", entrega = "", origen = "", coincide = "", observaciones = "", clave = "", descrip = "", cod_bar = "", um = "", lote = "", cadu = "", cajas = "", piezas = "", tarimas = "", marca = "", fec_fab = "", proveedor = "", tarimasInc = "",CostoU="";
    int PzxCaja = 0, tarimasC = 0, tarimasI = 0, cajasPorTarimaC = 0, cajasPorTarimaI = 0, resto = 0, cajasI = 0, cantidadPedido = 0, cantidadCompra = 0;

    try {
        con.conectar();
        ResultSet rset = con.consulta("select F_PzaCaja, F_ClaPro, F_Lote, F_FecCad, F_FecFab, F_Marca, F_Cb, F_Cajas, F_Pz, F_Tarimas, F_Resto, F_TarimasI, F_CajasI, F_FolRemi, F_Provee, F_Costo, F_OrdCom from tb_compratemp where F_IdCom = '" + ((String) sesion.getAttribute("id")) + "' ");
        while (rset.next()) {
            ...
            <div class="panel panel-primary">
                ...
                <form class="form-horizontal" role="form" name="formulario1" id="formulario1" method="post" action="../ModificacionesHH">
                    <div class="panel-body">
                        <div class="row">
                            <label for="folio" class="col-sm-2 control-label">Folio CEDIS CENTRAL</label>
                            <div class="col-sm-2">
                            ...
                            <div class="col-sm-2">
                                <a class="btn btn-block btn-primary"  href="compraAuto3.jsp" >Regresar</a>
                            </div>
                        </div>
                        <div class="row">
