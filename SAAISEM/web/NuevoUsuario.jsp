...
<html>
    <head>
        ...
        <title>SAA MULTIPROYECTO</title>
    </head>
    <body>
        <div class="container">
            <h1>SIALSS_CTRL MULTIPROYECTO</h1>
            <h4>Módulo - Sistema de Administraci&oacute;n de Almacenes (SAA)</h4>

            <%@include file="jspf/menuPrincipal.jspf"%>
            <div class="row">
                <div class="col-sm-12">
                    <h2>Nuevo Usuario SAA</h2>
                </div>
            </div>
            <form action="ModificacionPass" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="Nombre" min="4" maxlength="20" id="Nombre" placeholder="Ingrese Nombre" required="true"  autofocus="autofocus" onkeypress="return soloLetras(event)" />
                    </div>
                </div>
                <div class="row">
                    <label class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="ApellidoP"  min="4" maxlength="20" id="ApellidoP" placeholder="Ingrese Apellido Paterno" required="true"  autofocus="autofocus" onkeypress="return soloLetras(event)" />
                    </div>                    
                </div>
                <div class="row">
                    <label class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="ApellidoM" min="4" maxlength="20" id="ApellidoM" placeholder="Ingrese Apellido Materno" required="true"  autofocus="autofocus" onkeypress="return soloLetras(event)" />
                    </div>
                </div>
                <div class="row">
                    <label class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="id_mail" min="8" maxlength="30" id="id_mail"  placeholder="Ingrese Correo" required="true"  autofocus="autofocus"  onKeyup="javascript:validateMail('id_mail')"/>
                    </div>
                </div>
                <div class="row">
                    <label class="col-sm-2">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <input type="password" class="form-control" min="6" maxlength="18" name="pswd" id="pswd" placeholder="Ingrese Contraseña Nueva" autofocus="autofocus" required="true" />
                    </div>                    
                </div>
                <div class="row">
                    <label class="col-sm-2">
                    ...
                    <div class="col-sm-4">
                        <input type="password" class="form-control" min="6" maxlength="18" name="pswd2" id="pswd2" placeholder="Repita Contraseña Nueva" required="true" />
                    </div>
                </div>
                <div class="row">
                    <label class="col-sm-2">
            ...
            <div id="pswd_info">
                ...
                <ul>
                    ...
                    <li id="capital" class="invalid"><strong>Una Letra Mayuscula como Minimo</strong></li>
                    <li id="number" class="invalid"><strong>Un Número como Minimo</strong></li>
                    <li id="length" class="invalid"><strong>Minimo 8 Caracteres</strong></li>
